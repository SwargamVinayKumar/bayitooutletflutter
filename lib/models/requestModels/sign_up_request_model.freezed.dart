...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,mobile,name,email,password,confirmPassword,businessLogo,const DeepCollectionEquality().hash(images),businessLicence,businessName,outletType,aboutBusiness,location,gstIn,fssaiId);

@override
String toString() {
  return 'SignUpRequestModel(mobile: $mobile, name: $name, email: $email, password: $password, confirmPassword: $confirmPassword, businessLogo: $businessLogo, images: $images, businessLicence: $businessLicence, businessName: $businessName, outletType: $outletType, aboutBusiness: $aboutBusiness, location: $location, gstIn: $gstIn, fssaiId: $fssaiId)';
}
...
@useResult
$Res call({
 int? mobile, String? name, String? email, String? password, String? confirmPassword, String? businessLogo, List<String> images, String? businessLicence, String? businessName, String? outletType, String? aboutBusiness, LocationRequestModel? location, String? gstIn, String? fssaiId
});
...
/// Create a copy of SignUpRequestModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? mobile = freezed,Object? name = freezed,Object? email = freezed,Object? password = freezed,Object? confirmPassword = freezed,Object? businessLogo = freezed,Object? images = null,Object? businessLicence = freezed,Object? businessName = freezed,Object? outletType = freezed,Object? aboutBusiness = freezed,Object? location = freezed,Object? gstIn = freezed,Object? fssaiId = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? mobile,  String? name,  String? email,  String? password,  String? confirmPassword,  String? businessLogo,  List<String> images,  String? businessLicence,  String? businessName,  String? outletType,  String? aboutBusiness,  LocationRequestModel? location,  String? gstIn,  String? fssaiId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SignUpRequestModel() when $default != null:
return $default(_that.mobile,_that.name,_that.email,_that.password,_that.confirmPassword,_that.businessLogo,_that.images,_that.businessLicence,_that.businessName,_that.outletType,_that.aboutBusiness,_that.location,_that.gstIn,_that.fssaiId);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? mobile,  String? name,  String? email,  String? password,  String? confirmPassword,  String? businessLogo,  List<String> images,  String? businessLicence,  String? businessName,  String? outletType,  String? aboutBusiness,  LocationRequestModel? location,  String? gstIn,  String? fssaiId)  $default,) {final _that = this;
switch (_that) {
case _SignUpRequestModel():
return $default(_that.mobile,_that.name,_that.email,_that.password,_that.confirmPassword,_that.businessLogo,_that.images,_that.businessLicence,_that.businessName,_that.outletType,_that.aboutBusiness,_that.location,_that.gstIn,_that.fssaiId);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? mobile,  String? name,  String? email,  String? password,  String? confirmPassword,  String? businessLogo,  List<String> images,  String? businessLicence,  String? businessName,  String? outletType,  String? aboutBusiness,  LocationRequestModel? location,  String? gstIn,  String? fssaiId)?  $default,) {final _that = this;
switch (_that) {
case _SignUpRequestModel() when $default != null:
return $default(_that.mobile,_that.name,_that.email,_that.password,_that.confirmPassword,_that.businessLogo,_that.images,_that.businessLicence,_that.businessName,_that.outletType,_that.aboutBusiness,_that.location,_that.gstIn,_that.fssaiId);case _:
  return null;
...
class _SignUpRequestModel implements SignUpRequestModel {
  const _SignUpRequestModel({this.mobile, this.name, this.email, this.password, this.confirmPassword, this.businessLogo, final  List<String> images = const [], this.businessLicence, this.businessName, this.outletType, this.aboutBusiness, this.location, this.gstIn, this.fssaiId}): _images = images;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,mobile,name,email,password,confirmPassword,businessLogo,const DeepCollectionEquality().hash(_images),businessLicence,businessName,outletType,aboutBusiness,location,gstIn,fssaiId);
...
/// Create a copy of SignUpRequestModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? mobile = freezed,Object? name = freezed,Object? email = freezed,Object? password = freezed,Object? confirmPassword = freezed,Object? businessLogo = freezed,Object? images = null,Object? businessLicence = freezed,Object? businessName = freezed,Object? outletType = freezed,Object? aboutBusiness = freezed,Object? location = freezed,Object? gstIn = freezed,Object? fssaiId = freezed,}) {
