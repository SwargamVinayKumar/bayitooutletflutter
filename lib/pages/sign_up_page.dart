          ...
          child: Padding(
            ...
            child: Stack(
              children: [
                            ...
                            child: CustomGradientButton(
                              ...
                              onTap: () async {
                                ...
                                if (authViewModel.otpController.text.trim().length != 6) {
                                  Get.snackbar("Error", "Otp must be  6 characters");
                                  return;
                                }
                ...
                Obx(() => authViewModel.signUpObserver.value.maybeWhen(loading: () => Expanded(child: Container(color: Colors.black.withOpacity(0.2),child: Center(child: ProgressDialog(),))),orElse: () => SizedBox())),
                Obx(() => authViewModel.verifyOtpObserver.value.maybeWhen(loading: () => Expanded(child: Container(color: Colors.black.withOpacity(0.2),child: Center(child: ProgressDialog(),))),orElse: () => SizedBox()))
              ],
            ),
          ),
        ),
