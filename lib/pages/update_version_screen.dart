...
class _UpdateVersionScreenState extends State<UpdateVersionScreen> {
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              GestureDetector(
                onTap: launchEmail,
                child: Text("Contact admin for support \n bayitosupport@gmail.com",textAlign: TextAlign.center,style: TextStyle(
                    fontSize: 16,
                    color: CustomColors.primary,
                    fontWeight: FontWeight.w800,
                    fontStyle: FontStyle.normal
  ...
  final String playStoreUrl = "https://play.google.com/store/apps/details?id=com.bayito.outlet.bayitooutlet";
  final String appStoreUrl = "https://apps.apple.com/us/search?term=Bayito";
